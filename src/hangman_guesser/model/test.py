...
def train_eval(
    ...
    with tf.compat.v2.summary.record_if(
        ...
        life_initial = 15
        tf_env = tf_py_environment.TFPyEnvironment(HangmanEnvironment(dictionary_path, reward_map,life_initial))
        eval_tf_env = tf_py_environment.TFPyEnvironment(HangmanEnvironment(dictionary_path, reward_map,life_initial))
...
def create_recurrent_network(
    ...
    rnn_cell = tf.keras.layers.StackedRNNCells([fused_lstm_cell(s) for s in lstm_size])
    return sequential.Sequential(
